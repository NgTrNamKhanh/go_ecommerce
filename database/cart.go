...
var (
	ErrCantFindProduct    = errors.New("cant findd the product")
	ErrCantDecodeProducts = errors.New("cant findd the product")
	ErrUserIdIsNotValid   = errors.New("thiss user is not valid")
	ErrCantUpdateUser     = errors.New("cannot add this product to the cart")
	ErrCantRemoveItemCart = errors.New("cannot remove item from cart")
	ErrCantGetItem        = errors.New("cannot get the item")
	ErrCantBuyCartItem    = errors.New("cannot buy the item")
)
...
func BuyItemFromCart(ctx context.Context, userCollection *mongo.Collection, userID string) error {
	...
	grouping := bson.D{{Key: "$group", Value: bson.D{primitive.E{Key: "_id", Value: bson.D{primitive.E{Key: "$sum", Value: "$usercart.price"}}}}}}
